...
public class Squad {
    ...
    public static Squad setUpNewSquad(){return new Squad("Gamegirls",5,"Winning the Game");}
    public static Squad setUPNewSquad(){return new Squad("Fighters",5,"Big power");}
